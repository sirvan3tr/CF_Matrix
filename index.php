...
<div class="toggle-bar">Toggle: 
  ...
  <a href="#taskAdditionModal" id="batch_add_btn" class="btn btn-small btn-primary" type="button"  data-toggle="modal">Batch Add</a>
  <button id="batch_delete_btn" class="btn btn-small btn-primary" type="button">Batch Delete</button>
</div>
